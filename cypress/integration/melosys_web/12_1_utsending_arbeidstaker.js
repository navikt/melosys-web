...
describe("12.1 utsending arbeidstaker", () => {
  ...
  it("Kontroller stegvelger flyten", () => {
    cy.get(".panel.stegFane.steg0.stegFane--aktiv").find('[data-cy-nesteknapp="knapp_steg0"]').click();
    ...
    cy.get(".panel.stegFane.steg1.stegFane--aktiv")
      ...
      .should("be.checked");
    cy.get('[data-cy-nesteknapp="knapp_steg1"]').click();
    ...
    cy.get(".panel.stegFane.steg5.stegFane--aktiv")
      ...
      .check({ force: true })
      .should("be.checked");
    cy.get('[data-cy-nesteknapp="knapp_steg6"]').click({ force: true });
    ...
    cy.get(".panel.stegFane.steg6.stegFane--aktiv").find("button").click();

    cy.get(".panel.stegFane.steg7.stegFane--aktiv").find("textarea").type("fritekst til vedtaksbrev").blur();
    cy.get(".panel.stegFane.steg7.stegFane--aktiv").find('[data-cy="mottakerinstitusjoner"]').selectNth(1);
    cy.contains("Fatt vedtak").click();
