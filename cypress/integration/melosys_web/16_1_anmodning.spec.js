...
describe("16.1 anmodning om unntak flyt", () => {
  it("går gjennom uten krasj", () => {
    ...
    cy.get(aktivtStegSelector(0)).contains(nesteKnappTekst).click();
    ...
    cy.get(aktivtStegSelector(1))
      ...
      .should("be.checked");
    cy.get(aktivtStegSelector(1)).contains(nesteKnappTekst).click();

    cy.get(aktivtStegSelector(2)).find('[type="checkbox"]').eq(0).check({ force: true }).should("be.checked");
    cy.get(aktivtStegSelector(2)).contains(nesteKnappTekst).click();
    ...
    cy.get(aktivtStegSelector(3))
      ...
      .should("be.checked");
    cy.get(aktivtStegSelector(3)).contains(nesteKnappTekst).click();
    ...
    cy.get(aktivtStegSelector(4))
      ...
      .check({ force: true })
      .should("be.checked");
    cy.get(aktivtStegSelector(4)).contains(nesteKnappTekst).click();
    ...
    cy.get(aktivtStegSelector(5))
      ...
      .check({ force: true })
      .should("be.checked");
    cy.get(aktivtStegSelector(5)).contains(nesteKnappTekst).click();

    cy.get(aktivtStegSelector(6)).find('[name="artikkel12"]').eq(1).check({ force: true }).should("be.checked");
    cy.get(aktivtStegSelector(6))
      .find('input[type="text"]')
      .type(MKV.Terms.begrunnelser.art12_1_begrunnelser.UTSENDELSE_OVER_24_MN);
    cy.get(aktivtStegSelector(6)).find("button").contains("Legg til").click();
    cy.get(aktivtStegSelector(6)).contains(nesteKnappTekst).click();
    ...
    cy.get(aktivtStegSelector(7)).find("select").last().selectNth(1);
    cy.get(aktivtStegSelector(7)).contains("Send brevene").click();
