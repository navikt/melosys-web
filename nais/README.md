...
Husk også å bytte ut variabler som `INGRESSES` og `VITE_APP_NAME` med faktiske verdier. Verdiene for de ulike miljøene kan finnes i vars-dev.json, vars-prod.json osv.
