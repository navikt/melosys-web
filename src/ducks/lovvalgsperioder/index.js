import * as lovvalgsperioderOperations from "./operations";
import * as lovvalgsperioderSelectors from "./selectors";
...
export {
  ...
  lovvalgsperioderActions,
};

export default lovvalgsperioderReducers;
