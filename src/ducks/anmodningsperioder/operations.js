...
const byggAnmodningsperiodeArtikkel16 = state => {
  ...
  return [{
    ...
    lovvalgBestemmelse: MKV.Koder.lovvalgsbestemmelser.lovvalgsbestemmelser_883_2004.FO_883_2004_ART16_1,
...
const byggAnmodningsperioder = (lovvalgsbestemmelse, state) => {
  switch (lovvalgsbestemmelse) {
    case MKV.Koder.lovvalgsbestemmelser.lovvalgsbestemmelser_883_2004.FO_883_2004_ART16_1:
