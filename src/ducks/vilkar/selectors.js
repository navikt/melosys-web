...
export const inngangsvilkaarSelector = createSelector(VilkarSelector, (alleVilkar) =>
  alleVilkar.find((enkelt) => enkelt.vilkaar === MKV.Koder.vilkaar.FO_883_2004_INNGANGSVILKAAR)
);
