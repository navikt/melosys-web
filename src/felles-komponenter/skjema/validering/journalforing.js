...
const idErIkkeFnrEllerDnrEllerOrgnr = verdi => ((!(Person.erFnrLengde(verdi) || Person.erDnrLengde(verdi) || Organisasjon.erOrgnr(verdi))) && 'Tast inn gyldig fnr, dnr eller orgnr.');
