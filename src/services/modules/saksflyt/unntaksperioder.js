import { postAsJson, putAsText, putAsJson } from '../../utils';
import { API_BASE_URL, SAKSFLYT, UNNTAKSPERIODER } from '../../api-constants';

// eslint-disable-next-line import/prefer-default-export
export const godkjenn = (behandlingID, data = {}) => putAsJson(`${API_BASE_URL}${SAKSFLYT}/${UNNTAKSPERIODER}/${behandlingID}/godkjenn`, data);
