...
interface AnmodningOmUnntakBestilling {
  mottakerinstitusjon: string | null,
  fritekstSed: string | null,
}
export const bestill = (behandlingID: number, body: AnmodningOmUnntakBestilling) => postAsJson(`${API_BASE_URL}${SAKSFLYT}/${ANMODNINGSPERIODER}/${behandlingID}/bestill`, body);
