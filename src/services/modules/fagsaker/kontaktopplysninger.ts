...
export const send = (saksnr: string, juridiskorgnr: string, data: SendReqDto) => postAsJson(`${API_BASE_URL}${FAGSAKER}/${saksnr}/kontaktopplysninger/${juridiskorgnr}`, data);

export const slett = (saksnr: string, juridiskorgnr: string) => deleteAsJson(`${API_BASE_URL}${FAGSAKER}/${saksnr}/kontaktopplysninger/${juridiskorgnr}`);
