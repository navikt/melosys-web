 ...
 */
export const forhandsvisBrev = (behandlingID, produserbartDokument, data) =>
  postAsJsonReceiveAsPDF(
    `${API_BASE_URL}${DOKUMENTER}/pdf/brev/utkast/${behandlingID}/${produserbartDokument}`,
    data,
    true
  );
