...
export const TRYGDEAVTALE_FLYT_BASE_URL = `${process.env.VITE_TRYGDEAVTALE_FLYT_BASE_URL}`;
export const FAKTURERINGSKOMPONENTEN_FLYT_BASE_URL = `${process.env.VITE_FAKTURERINGSKOMPONENTEN_FLYT_BASE_URL}`;
