...
const InntektListePropType = PT.arrayOf(
  PT.shape({
...
const ArbeidsInntektMaanedListePropType = PT.arrayOf(
  PT.shape({
...
const ArbeidsforholdFrilanserListePropType = PT.arrayOf(
  PT.shape({
...
const FrilansInntektMaanedListePropType = PT.arrayOf(
  PT.shape({
