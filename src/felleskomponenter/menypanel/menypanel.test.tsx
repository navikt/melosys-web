...
describe('MenyPanel', () => {
  ...
  each([
    ...
    SED,
    SØKNAD_FOLKETRYGDEN,
  ]).it('viser ikke arbeidsforholdrolleetiketter hvis behandlingsgrunnlagtype er %p', behandlingsgrunnlagtype => {
  ...
  each([
    ...
    ØVRIGE_SED_UFM,
    TRYGDETID,
  ]).it(`viser ikke behandlingsgrunnlagdata hvis behandlingstype er ${behandlingstyper.SED} og behandlingstema er %p`, behandlingstema => {
  ...
  ]).it('viser behandlingsgrunnlagetikett med tekst "Fra SED" ved behandlingstype %p', behandlingstype => {
  ...
  ]).it('viser behandlingsgrunnlagetikett med tekst "Fra Søknad" ved behandlingstype %p', behandlingstype => {
    props.behandlingstype = behandlingstype;
    const menypanel = shallow(<Menypanel {...props} />);
    const activeContent = menypanel.find(Nav.Panel);
