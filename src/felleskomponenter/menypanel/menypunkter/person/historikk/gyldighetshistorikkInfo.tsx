    ...
    <div className="gyldighetshistorikk-info">
      ...
      <Nav.HelpText title="Historikk hjelpetekst" strategy="fixed">
        ...
        <p>
          ...
          gjelder fra. På andre opplysningstyper viser datoen når opplysningen ble gyldig i Folkeregisteret, ikke når
          den ble gyldig i virkeligheten. For eksempel viser ikke gyldighetsdato for opplysningstypen utflytting når man
