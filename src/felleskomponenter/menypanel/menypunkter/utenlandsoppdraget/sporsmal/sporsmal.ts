export const erErstatningTidligereUtsendte = "Erstatter arbeidstakeren en annen utsendt person?";
export const erUtsendelseForOppdragIUtlandet =
  "Har arbeidsgiveren behov for å sende en ansatt ut for å utføre et oppdrag/arbeid i det aktuelle landet?";
