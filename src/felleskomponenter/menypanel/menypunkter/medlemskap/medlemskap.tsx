...
export const Medlemskap = (props: PropsFromRedux) => {
  ...
  return (
    <div className="medlemskap panelSeksjon">
      <Nav.Typo.Undertittel className="medlemskap__gruppeoverskrift">Perioder med medlemskap</Nav.Typo.Undertittel>
      ...
      <Nav.Typo.Undertittel className="medlemskap__gruppeoverskrift">Perioder uten medlemskap</Nav.Typo.Undertittel>
      <section className="medlemskapgruppe__liste">
