...
const MaritimtEnkelt = ({
  ...
  return (
    <Fragment>
      <Nav.Row>
        <Nav.Column xs="5">
          <Skjema.Input feltNavn={`${navn}.foretakNavn`} label="Navn på foretak i arbeidslandet" disabled={!redigerbart} />
        </Nav.Column>
        <Nav.Column xs="5">
          <Skjema.Input feltNavn={`${navn}.foretakOrgnr`} label="Organisasjonsnummer/ID-nummer" disabled={!redigerbart} />
        </Nav.Column>
      </Nav.Row>
      <Nav.Fieldset legend="">
        <Nav.Row>
