...
export const STEG = {
  ...
  ARBEID_ETT_LAND_OVRIG_VEDTAK: 'ARBEID_ETT_LAND_OVRIG_VEDTAK',
  FTRL_START: 'FTRL_START',
  FTRL_VURDERING: 'FTRL_VURDERING',
  FTRL_VIRKSOMHET: 'FTRL_VIRKSOMHET',
  FTRL_MEDLEMSKAP: 'FTRL_MEDLEMSKAP',
  FTRL_AVGIFT: 'FTRL_AVGIFT',
  FTRL_REPRESENTANT: 'FTRL_REPRESENTANT',
  FTRL_FAMILIE: 'FTRL_FAMILIE',
  FTRL_VEDTAK: 'FTRL_VEDTAK',
};
