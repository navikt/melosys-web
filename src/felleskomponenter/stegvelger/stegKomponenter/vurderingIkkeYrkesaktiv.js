...
const IkkeYrkesaktiv = () => (
  <Nav.Fieldset legend="Vurder om søkeren er:">
    <Skjema.Radio
      feltNavn="avklartefaktaIkkeYrkesaktivType"
      value={KV.Koder.VurderingIkkeYrkesaktivTyper.STUDENT}
      label="Student"
    />
    <Skjema.Radio
      feltNavn="avklartefaktaIkkeYrkesaktivType"
      value={KV.Koder.VurderingIkkeYrkesaktivTyper.PENSJONIST}
      label="Pensjonist"
    />
    <Skjema.Radio
      feltNavn="avklartefaktaIkkeYrkesaktivType"
      value={KV.Koder.VurderingIkkeYrkesaktivTyper.INGEN_AV_DISSE}
