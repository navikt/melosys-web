...
const VekslingMellomLand = () => (
  <Nav.Fieldset legend="Veksler søker regelmessig mellom arbeid i flere land eller arbeider søker i flere land?">
    <Skjema.Radio
      feltNavn="avklartefaktaVekslingMellomLand"
      value={KV.Koder.VurderingVirksomhetTyper.EN_ELLER_BEGGE}
      label="Ja, en eller begge"
    />
    <Skjema.Radio
      feltNavn="avklartefaktaVekslingMellomLand"
      value={KV.Koder.VurderingVirksomhetTyper.INGEN_VEKSLING}
...
const MarginaltArbeid = () => (
  <Nav.Fieldset legend="Er arbeidet søker utfører som offentlig tjenesteperson for Norsk forvaltning marginalt (mindre enn 5%)?">
    <Skjema.Radio
      feltNavn="avklartefaktaMarginaltArbeid"
      value={KV.Koder.VurderingVirksomhetTyper.MARGINALT_JA}
      label="Ja"
    />
    <Skjema.Radio
      feltNavn="avklartefaktaMarginaltArbeid"
      value={KV.Koder.VurderingVirksomhetTyper.MARGINALT_NEI}
      label="Nei"
    />
  </Nav.Fieldset>
);
...
const AktivitetINorge = () => (
  <Nav.Fieldset legend="Hvor mye av aktiviteten skjer i Norge?">
    <Skjema.Radio
      feltNavn="avklartefaktaAktivitetINorge"
      value={KV.Koder.VurderingVirksomhetTyper.UNDER_25_PROSENT}
      label="Mindre enn 25%"
    />
    <Skjema.Radio
      feltNavn="avklartefaktaAktivitetINorge"
      value={KV.Koder.VurderingVirksomhetTyper.OVER_25_PROSENT}
      label="25% eller mer"
    />
  </Nav.Fieldset>
);
