...
export const feltGrupper = {
  ...
  faktaavklaring: {
    ...
    faktaavklaringForretningsstedBeslutningLand1: [],
    faktaavklaringForretningsstedVesentligLand1: [],
    faktaavklaringForretningsstedBeslutningLand2: [],
    faktaavklaringForretningsstedVesentligLand2: [],
    faktaavklaringForretningsstedBeslutningLand3: [],
    faktaavklaringForretningsstedVesentligLand3: [],
