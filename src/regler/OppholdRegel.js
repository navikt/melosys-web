...
class OppholdRegel extends DomeneRegel {
  ...
  erINorgeSeksManederEllerMerPerKalenderAr = () => {
    ...
    const harMangelfulleOpplysninger =
      skjema.antallMaanederINorge === null || skjema.antallMaanederINorge === undefined;
  ...
  harSammeAdresseSomArbeidsgiver = () => {
    ...
    const harMangelfulleOpplysninger =
      sammeAdresseSomArbeidsgiver === null || sammeAdresseSomArbeidsgiver === undefined;
    if (harMangelfulleOpplysninger) {
      return this.manglerOpplysninger(manglerInfoTekst);
    }
