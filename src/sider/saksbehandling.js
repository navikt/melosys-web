...
const mapStateToProps = state => ({
  ...
  initialValues: {
    ...
    arbeidUtlandGateadresse: soknadSelectors.ArbeidUtlandSelector(state).arbeidUtlandGateadresse,
    arbeidUtlandPostnummer: soknadSelectors.ArbeidUtlandSelector(state).arbeidUtlandPostnummer,
    arbeidUtlandPoststed: soknadSelectors.ArbeidUtlandSelector(state).arbeidUtlandPoststed,
    arbeidUtlandLand: soknadSelectors.ArbeidUtlandSelector(state).arbeidUtlandLand,
