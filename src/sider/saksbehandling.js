...
const mapStateToProps = state => ({
  ...
  initialValues: {
    ...
    arbeidUtlandGateadresse: soknadSelectors.OppholdUtlandSelector(state).arbeidUtlandGateadresse,
    arbeidUtlandPostnummer: soknadSelectors.OppholdUtlandSelector(state).arbeidUtlandPostnummer,
    arbeidUtlandPoststed: soknadSelectors.OppholdUtlandSelector(state).arbeidUtlandPoststed,
    arbeidUtlandRegion: soknadSelectors.OppholdUtlandSelector(state).arbeidUtlandRegion,
    arbeidUtlandLand: soknadSelectors.OppholdUtlandSelector(state).arbeidUtlandLand,
    arbeidsandelUtland: soknadSelectors.OppholdUtlandSelector(state).arbeidsandelUtland,
    arbeidsandelNorge: soknadSelectors.OppholdUtlandSelector(state).arbeidsandelNorge,
