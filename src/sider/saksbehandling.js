...
const mapStateToProps = state => ({
  ...
  initialValues: {
    ...
    faktaavklaringBostedslandSnarvei: faktaavklaringSelectors.FaktaavklaringBostedslandSnarveiSelector(state),
    faktaavklaringBostedsland: faktaavklaringSelectors.FaktaavklaringBostedslandSelector(state),
