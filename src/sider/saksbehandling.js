...
const mapStateToProps = state => ({
  ...
  initialValues: {
    ...
    faktaavklaringForretningsstedVesentligLand2: FaktaavklaringForretningsstedSelector(state).vesentligLand2,
    faktaavklaringForretningsstedBeslutningLand3: FaktaavklaringForretningsstedSelector(state).beslutningLand3,
    faktaavklaringForretningsstedVesentligLand3: FaktaavklaringForretningsstedSelector(state).vesentligLand3,
