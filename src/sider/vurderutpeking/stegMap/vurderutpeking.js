...
class VurderUtpeking extends Steg {
  constructor(propsLight, stegPosisjon) {
    ...
    const lovvalgNorge = behandlingstype.kode === MKV.Koder.behandlinger.behandlingstema.BESLUTNING_LOVVALG_NORGE;
    const lovvalgAnnetLand = behandlingstype.kode === MKV.Koder.behandlinger.behandlingstema.BESLUTNING_LOVVALG_ANNET_LAND;
