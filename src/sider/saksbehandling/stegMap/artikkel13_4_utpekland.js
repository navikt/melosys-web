...
class Artikkel13_4_UtpekLand extends Steg {
  constructor(propsLight, stegPosisjon) {
    super(propsLight, stegPosisjon);
    this.kriterier = [];
    this.id = STEG.ARTIKKEL_13_4_UTPEK_LAND;
    ...
    this.beregnRelevantUI = _propsLight => ({
      overskrift: 'Utpek land etter artikkel 13.4',
    });
    this.handlers = {
...
export default Artikkel13_4_UtpekLand;
