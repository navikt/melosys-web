    ...
    <div className="vurderingArbeidsgiver">
      ...
      <div className="arbeidsgiver">
        ...
        <div className="fane__knapplinje">
          <Nav.Knapp disabled={!(redigerbart && harAvklaring)} className="fane__navigasjonsknapp" cy_nesteknapp="knapp_steg3" onClick={bekreftOgFortsett}>Bekreft og fortsett</Nav.Knapp>
        </div>
      </div>
    </div>
  );
