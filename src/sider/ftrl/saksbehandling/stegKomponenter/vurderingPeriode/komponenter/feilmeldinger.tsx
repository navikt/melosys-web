...
const bestemmelseEr2_2_1 = (bestemmelse: string) => {
  return bestemmelse === FTRL_KAP2_2_1_FØRSTE_LEDD || bestemmelse === FTRL_KAP2_2_1_FJERDE_LEDD || FTRL_KAP2_2_1; // Skal etterhvert erstattes med bare FTRL_KAP2_2_1. Erstatt denne når toggle pliktige_bestemmelser skrus av
};
