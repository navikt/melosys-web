...
const BestemmelseHjelpetekst = ({ bestemmelse }: { bestemmelse?: string }) => {
  ...
  const ikkeKravOmTidsbegrensning = [UK_ART6_5, UK_ART7_3, UK_ART8_2, USA_ART5_5].includes(bestemmelse);
  ...
  return (
    <div className="bestemmelse-hjelpetekst">
      ...
      {ikkeKravOmTidsbegrensning && <div>Det er ikke krav om at arbeidsperioden/utsendingen er tidsbegrenset.</div>}
    </div>
  );
};
