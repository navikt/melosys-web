...
export const FTRL_SOKNADSLAND = 'FTRL_SOKNADSLAND';
export const FTRL_SOKNADSPERIODE = 'FTRL_SOKNADSPERIODE';
...
export const avklartefaktaKoder = {
  ...
  FTRL_SOKNADSLAND: 'FTRL_SOKNADSLAND',
  FTRL_SOKNADSPERIODE: 'FTRL_SOKNADSPERIODE',
};
