...
describe('fjernFlereKoder', () => {
  it('fjerner koder', () => {
    ...
    expect(rensetKodeverk.KTObjects.begrunnelser.art12_1_vesentlig_virksomhet.find(kode => kode === MKV.Koder.begrunnelser.art12_1_vesentlig_virksomhet.KONTRAKTER_IKKE_NORSK_LOV)).toBeUndefined();
  });
});
